...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      googleCalendarApiKey: 'AIzaSyA2c_cFy471UHVfGWvEhAKeIdfkRNtSdfU',
      // US Holidays
      events: 'rishi30.mehta@gmail.com',
      eventTextColor: 'white',
      eventBorderColor: '#BFBFBF',
      eventBackgroundColor: '#1A9EF3',                                         
      dateClick: function(info){
        const startTime = prompt("Start Time?")
        const updatedStart = "T"+startTime
        const endTime = prompt("End Time?")
        const updatedEnd = "T"+endTime
        calendar.addEvent({
            groupId: 999,
            title: 'Free Time',
            start: info.dateStr+updatedStart,
            end: info.dateStr+updatedEnd,
          });
      },
